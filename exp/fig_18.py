...
def main(cmd: CMDManager, tp: LogParser):
    plot_data = {
        ...
        'Y_data': {ckpt_interval: {} for ckpt_interval in ckpt_intervals},
    }
    method = 'aceso'
    ...
    for ckpt_interval in ckpt_intervals:
        ...
        print_GOOD(f"[FINISHED POINT] method={method} ckpt_interval={ckpt_interval} time_dict={recover_time_dict}")
        plot_data['Y_data'][ckpt_interval] = recover_time_dict
