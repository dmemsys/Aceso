...
run_times          = fig_params['run_time']

@print_func_time
def main(cmd: CMDManager, tp: LogParser):
    plot_data = {
        'X_data': run_times,
        'Y_data': {run_time: {} for run_time in run_times},
    }
    method = 'aceso'
    ...
    for run_time in run_times:
        ...
        print_GOOD(f"[FINISHED POINT] method={method} run_time={run_time} time_dict={recover_time_dict}")
        plot_data['Y_data'][run_time]["time_dict"] = recover_time_dict
